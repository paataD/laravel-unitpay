...
use PaataD\UnitPay\Test\Dummy\Order;
use PaataD\UnitPay\UnitPayNotifiable;
use PaataD\UnitPay\Events\UnitPayEvent;
use PaataD\UnitPay\UnitPayNotification;
use PaataD\UnitPay\Test\Dummy\AnotherNotifiable;
use PaataD\UnitPay\Test\Dummy\AnotherNotification;
...
class UnitPayTest extends TestCase
{
    ...
    {
        $this->expectException('PaataD\UnitPay\Exceptions\InvalidConfiguration');
